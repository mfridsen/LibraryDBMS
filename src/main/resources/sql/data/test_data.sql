...
-- classifications (, '', '', ),
INSERT INTO classifications (classificationID, classificationName, description, deleted) VALUES
(1, 'Physics', 'Scientific literature on the topic of physics.', 0),
...
-- items (, '', '', '', , , , , , ),
INSERT INTO items (itemID, title, itemType, barcode, authorID, classificationID, allowedRentalDays, available, deleted) VALUES
(1, 'item1', 'REFERENCE_LITERATURE', '1', 1, 1, 0, 1, 0),
(2, 'item2', 'MAGAZINE', '2', 2, 2, 0, 1, 0),
(3, 'item3', 'COURSE_LITERATURE', '3', 3, 3, 14, 1, 0),
(4, 'item4', 'OTHER_BOOKS', '4', 4, 4, 28, 1, 0),
(5, 'item5', 'REFERENCE_LITERATURE', '5', 5, 5, 0, 1, 0),
...
-- literature (, ''),
INSERT INTO literature (literatureID, ISBN) VALUES
(1, '9783161484100'),
(2, '9780262134729'),
(3, '9780123849342'),
(4, '9780123849359'),
...
-- films (, '', '', ''),
INSERT INTO films (filmID, ageRating, countryOfProduction, actors) VALUES
(6, 15, 'USA', 'Actor1, Actor2, Actor3'),
...
INSERT INTO users (userID, username, password, userType, email, allowedRentals, currentRentals, lateFee, allowedToRent, deleted) VALUES
(1, 'user1', 'password1', 'ADMIN', 'admin@example.com', 5, 0, 0.0, 1, 0),
(2, 'user2', 'password2', 'STAFF', 'staff@example.com', 5, 0, 0.0, 1, 0),
(3, 'user3', 'password3', 'PATRON', 'patron@example.com', 5, 0, 0.0, 1, 0),
(4, 'user4', 'password4', 'STUDENT', 'student@example.com', 5, 0, 0.0, 1, 0),
(5, 'user5', 'password5', 'TEACHER', 'teacher@example.com', 5, 0, 0.0, 1, 0),
(6, 'user6', 'password6', 'RESEARCHER', 'researcher@example.com', 5, 0, 0.0, 1, 0),
(7, 'user7', 'password7', 'ADMIN', 'admin2@example.com', 5, 0, 0.0, 1, 0),
(8, 'user8', 'password8', 'PATRON', 'patron2@example.com', 5, 0, 0.0, 1, 0),
(9, 'user9', 'password9', 'STAFF', 'staff2@example.com', 5, 0, 0.0, 1, 0),
