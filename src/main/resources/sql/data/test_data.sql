...
(1, 'user1', 'password1', 'ADMIN', 'admin@example.com', 0, 0, 0.0, 1, 0),
(2, 'user2', 'password2', 'STAFF', 'staff@example.com', 0, 0, 0.0, 1, 0),
...
(7, 'user7', 'password7', 'ADMIN', 'admin2@example.com', 0, 0, 0.0, 1, 0),
(8, 'user8', 'password8', 'PATRON', 'patron2@example.com', 3, 0, 0.0, 1, 0),
(9, 'user9', 'password9', 'STAFF', 'staff2@example.com', 0, 0, 0.0, 1, 0),
