...
public class DummyControlTest {
    ...
    /**
     * Tests all constructors in ControlDummy.
     */
    @Test
    @Order(1)
    public void testCreateDummyControl() {
        System.out.println("\n" + testClassTextBlock);
        System.out.println("1: Testing creating ControlDummy...");
